...
Original file is located at
    https://colab.research.google.com/drive/1t9e-eTCBa7ItsO1VgiNDMgJsknGMI_47
...
"""MAPE yang rendah menunjukkan bahwa model memiliki tingkat akurasi tinggi dalam konteks prediksi harga saham. RMSE yang cukup kecil dan R² yang mendekati 1 menunjukkan bahwa model memiliki kemampuan generalisasi yang baik."""

# Visualisasi hasil prediksi LSTM vs Actual
plt.figure(figsize=(12, 3))
plt.plot(df_clean.index[train_size + time_step + 1:], y_test_actual, label='Harga Aktual', color='blue')
plt.plot(df_clean.index[train_size + time_step + 1:], predictions, label='Prediksi LSTM', color='red')
...
"""Garis prediksi (merah) secara umum mengikuti pergerakan harga aktual (biru), terutama dalam mencerminkan arah tren naik dan turun. Memperlihatkan bahwa model dapat memberikan gambaran umum mengenai kecenderungan pergerakan harga saham di masa depan, yang berguna sebagai bahan pertimbangan dalam pengambilan keputusan investasi."""
